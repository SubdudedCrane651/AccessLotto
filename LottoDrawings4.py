...
with ThreadPoolExecutor(max_workers=4) as executor:
    if lotto == 1:
        ...
        os.system('F:/Python/Blood_Pressure_Tracker/BOSGAME/.venv/Scripts/python.exe F:\\Python\\text2speech\\text2speech.py "--lang=fr" "Voici les numeros gagnants de Lotto 6/49"')
    ...
    if lotto == 3:
        ...
        os.system('F:/Python/Blood_Pressure_Tracker/BOSGAME/.venv/Scripts/python.exe F:\\Python\\text2speech\\text2speech.py "--lang=fr" "Voici les numeros gagnants de la Grande Vie"')
    ...
    if lotto == 4:
        ...
        os.system('F:/Python/Blood_Pressure_Tracker/BOSGAME/.venv/Scripts/python.exe F:\\Python\\text2speech\\text2speech.py "--lang=fr" "Voici les numeros gagnants de Tout ou rien"')
input("<PRESS ENTER>")
